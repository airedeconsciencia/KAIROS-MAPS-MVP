...
(function () {
  ...
  var SCHEMA_VERSION = '3.8h.2-f4.11-0.1';
  ...
  /** @type {Record<string, string>} slug canónico → familia (94 países) */
  var COUNTRY_EDITORIAL_FAMILY = {
    ...
    madagascar: 'AFRICAN_COASTAL',
    mauritius: 'AFRICAN_COASTAL',
    namibia: 'AFRICAN_COASTAL',

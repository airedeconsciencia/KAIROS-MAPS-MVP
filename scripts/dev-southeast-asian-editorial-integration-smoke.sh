...
assert(
  '9 familias registradas',
  EFR.REGISTERED_FAMILIES.length === 9 && EFR.isRegisteredFamily('SOUTHEAST_ASIAN') === true,
...
const QA_REGRESSION = [
  ...
  { label: 'Delhi / amor → IBERIAN', cityName: 'Delhi', slug: 'india', goal: 'amor', expected: 'IBERIAN' }
];

...
assert(
  '38 ciudades resuelven familia editorial',
  Object.keys(cityFamilies).length === 38,
...
assert('29 casos split-brain = 0', splitBrainHits.length === 0, splitBrainHits.join(' · '));
...
assert(
  'Pipeline knowledge ≡ narrative (29 casos)',

...
assert(
  '68 ciudades resuelven familia editorial',
  Object.keys(cityFamilies).length === 68,
...
assert('59 casos split-brain = 0', splitBrainHits.length === 0, splitBrainHits.join(' · '));
...
assert(
  'Pipeline knowledge ≡ narrative (59 casos)',

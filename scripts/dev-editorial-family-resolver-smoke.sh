...
assert(
  '72 ciudades resuelven familia editorial',
  Object.keys(cityFamilies).length === 72,
...
assert('63 casos split-brain = 0', splitBrainHits.length === 0, splitBrainHits.join(' · '));
...
assert(
  'Pipeline knowledge ≡ narrative (63 casos)',

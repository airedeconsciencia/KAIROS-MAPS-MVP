...
assert(
  '70 ciudades resuelven familia editorial',
  Object.keys(cityFamilies).length === 70,
...
assert('61 casos split-brain = 0', splitBrainHits.length === 0, splitBrainHits.join(' · '));
...
assert(
  'Pipeline knowledge ≡ narrative (61 casos)',

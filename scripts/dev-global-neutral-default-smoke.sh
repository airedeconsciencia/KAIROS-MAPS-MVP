...
assert(
  ...
  EFR.SCHEMA_VERSION.indexOf('f2.2d3') !== -1 ||
    ...
    EFR.SCHEMA_VERSION.indexOf('f6.3') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f6.2') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f6.1') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f6.0') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f5.2') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f5.1') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f4.11') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f4.10') !== -1 ||
    EFR.SCHEMA_VERSION.indexOf('f4.9') !== -1 ||

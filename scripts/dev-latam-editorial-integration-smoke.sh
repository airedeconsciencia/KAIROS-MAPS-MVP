...
echo " Scope: 97/94 catálogo · CR/PA/PY/BO · amends · regresiones · anti-leak"
echo "══════════════════════════════════════════════════════════"
echo ""
...
assert(
  '97 ciudades / 94 países catálogo (F4.11 AFRICAN_COASTAL Southern; LATAM Wave A intacto)',
...
assert(
  '94 países resolver (F4.11 AFRICAN_COASTAL Southern)',

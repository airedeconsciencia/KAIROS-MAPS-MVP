...
- `dev-identity-micro-modulation-smoke.sh` — F8.5A4 · toneBias V1 · Lisboa canario · meaningStability=1 · Lexical Guard · no wiring prod
...
*Checkpoint F8.5C · toneBias V1 frozen · Prod 106/103 @ f6.3 · smokes PASS · sin activación prod · STOP @ F8.5B*
